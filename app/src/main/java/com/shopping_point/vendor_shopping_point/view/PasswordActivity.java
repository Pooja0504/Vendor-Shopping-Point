...
import com.shopping_point.vendor_shopping_point.databinding.ActivityPasswordBinding;
...
import com.shopping_point.vendor_shopping_point.viewModel.PasswordViewModel;
...
if(!isActivityRunning) {
    ...
    String oldPassword = LoginUtils.getInstance(this).getVendorInfo().getPassword().trim();
